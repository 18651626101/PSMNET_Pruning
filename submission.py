...
parser.add_argument('--KITTI', default='2015',
                    help='KITTI version')
parser.add_argument('--datapath', default='/home/jump/dataset/kitti2015/testing/',
                    help='select model')
parser.add_argument('--loadmodel', default='/home/jump/stereo/PSMNet_simplify/Ptrained_0.6/QQfinetune_100.tar',
                    help='loading model')
...
def main():
   ...
   for inx in range(len(test_left_img)):
       ...
       skimage.io.imsave('./png/'+test_left_img[inx].split('/')[-1],(img*256).astype('uint16'))
