...
parser.add_argument('--loadmodel', default='/home/jump/stereo/PSMNet_simplify/trained/pruned_0.5.tar',
                    help='load model')#每次跑改这个
parser.add_argument('--savemodel', default='/home/jump/stereo/PSMNet_simplify/traind_0.5/',
                    help='save model')#每次跑改这个
...
#for p in model.parameters():
 #   pramameter_sum=pramameter_sum+p.data.nelement()
    #layer_num=layer_num+1
    #print(pramameter_sum)
#print(layer_num)
#print(model)
