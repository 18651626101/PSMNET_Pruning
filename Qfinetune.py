...
parser.add_argument('--loadmodel', default='/home/jump/stereo/PSMNet_simplify/pretrained/pretrained_model_KITTI2015.tar',
                    help='load model')
parser.add_argument('--savemodel', default='./Ptrained_0.8/',
                    help='save model')
...
def main():
	...
	for epoch in range(1, args.epochs+1):
		...
		if epoch%100 == 0:
			...
			savefilename = args.savemodel+'Qfinetune_'+str(epoch)+'.tar'
