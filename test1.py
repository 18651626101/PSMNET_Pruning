...
parser.add_argument('--datapath', default='/home/jump/dataset/kitti2015/training/',
                    help='datapath')
parser.add_argument('--loadmodel', default='./Ptrained_0.9/finetune_150.tar',
                     help='load model')
...
def test(imgL,imgR,disp_true,n):
        model.eval()
        ...
        temp = temp[0, :, :]
        skimage.io.imsave('./result_P0.9/'+str(n)+'.png', (temp*256).astype('uint16'))
